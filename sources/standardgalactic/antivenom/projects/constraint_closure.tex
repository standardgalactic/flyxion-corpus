...
\title{\textbf{From Managed Activity to Constraint Closure}\\[0.5em]
\large A Selection-Theoretic Replacement for Bullshit Jobs}
\author{Flyxion}
\date{}
...
\begin{abstract}
Modern institutions optimize for the management of signals rather than
the closure of constraints. This produces a stable class of
